...
from unitree_rl_lab.assets.robots.unitree import BOSTONDYNAMIC_ATLAS4_CFG
...
class RobotSceneCfg(InteractiveSceneCfg):
    ...
    # robots
    robot: ArticulationCfg = BOSTONDYNAMIC_ATLAS4_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
