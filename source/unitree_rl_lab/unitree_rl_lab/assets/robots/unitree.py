...
XHUMANOID_LITE0430_CFG = UnitreeArticulationCfg(
    ...
    init_state=ArticulationCfg.InitialStateCfg(
        pos=(0.0, 0.0, 1.1),
        joint_pos={
            "hip_pitch_.*_joint": -0.1,  # [-0.97, 0.97]
            "knee_pitch_.*_joint": 0.3,  # [0.1745, 2.443]
            "ankle_pitch_.*_joint": -0.2,  # [-1.22, 0.5236]
            "shoulder_pitch_.*_joint": 0.20,  # [-3.14, 0.97]
            "elbow_.*_joint": -0.32,  # [-2.1, 0]
            # "hip_pitch_r_joint": -0.1,
            # "knee_pitch_r_joint": 0.3,
            # "ankle_pitch_r_joint": -0.2,
            # "shoulder_pitch_r_joint": 0.20,
            # "elbow_r_joint": -0.32,
        },
        joint_vel={".*": 0.0},
    ),
    ...
    actuators={
        "legs": ImplicitActuatorCfg(
            ...
            effort_limit_sim={
                ...
                "waist_joint": 1000.0,
                # "hip_yaw_r_joint": 90.0,
                # "hip_roll_r_joint": 150.0,
                # "hip_pitch_r_joint": 150.0,
                # "knee_pitch_r_joint": 150.0,
            },
            velocity_limit_sim={
                ...
                # "waist_joint": 100.0,
                # "hip_yaw_r_joint": 14.0,
                # "hip_roll_r_joint": 12.0,
                # "hip_pitch_r_joint": 12.0,
                # "knee_pitch_r_joint": 12.0,
            },
            stiffness={
                "hip_.*_joint": 150.0,
                "knee_.*_joint": 200.0,
        ...
        "arms": ImplicitActuatorCfg(
            ...
            effort_limit_sim={
                "shoulder_pitch_.*_joint": 40.0,
                "shoulder_roll_.*_joint": 40.0,
                "shoulder_yaw_.*_joint": 18.0,
                "elbow_.*_joint": 18.0,
                # "shoulder_pitch_r_joint": 40.0,
                # "shoulder_roll_r_joint": 40.0,
                # "shoulder_yaw_r_joint": 18.0,
                # "elbow_r_joint": 18.0,
            },
            velocity_limit_sim={
                "shoulder_pitch_.*_joint": 9.0,
                "shoulder_roll_.*_joint": 9.0,
                "shoulder_yaw_.*_joint": 20.0,
                "elbow_.*_joint": 20.0,
                # "shoulder_pitch_r_joint": 9.0,
                # "shoulder_roll_r_joint": 9.0,
                # "shoulder_yaw_r_joint": 20.0,
                # "elbow_r_joint": 20.0,
            },
            stiffness={
                "shoulder_pitch_.*_joint": 100.0,
                "shoulder_roll_.*_joint": 50.0,
                "shoulder_yaw_.*_joint": 50.0,
                "elbow_.*_joint": 50.0,
                # "shoulder_pitch_r_joint": 100.0,
                # "shoulder_roll_r_joint": 50.0,
                # "shoulder_yaw_r_joint": 50.0,
                # "elbow_r_joint": 50.0,
            },
            damping={
                "shoulder_pitch_.*_joint": 2.0,
                "shoulder_roll_.*_joint": 2.0,
                "shoulder_yaw_.*_joint": 2.0,
                "elbow_.*_joint": 2.0,
                # "shoulder_pitch_r_joint": 2.0,
                # "shoulder_roll_r_joint": 2.0,
                # "shoulder_yaw_r_joint": 2.0,
                # "elbow_r_joint": 2.0,
            },
        ),
    },
